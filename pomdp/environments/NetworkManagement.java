...
/*
	public double tr( int iStartState, int iAction, int iEndState ){
		boolean[] abStartState = indexToState( iStartState ), abEndState = indexToState( iEndState );
		/*
		System.out.print( "tr( " + toString( abStartState ) + ", " );
		if( iAction < m_cMachines )
			System.out.print( "reset( " + iAction + " )" );
		else if( iAction < m_cMachines * 2 )
			System.out.print( "ping( " + iAction + " )" );
		else
			System.out.print( "do-nothing" );
		
		double dTr = tr( abStartState, iAction, abEndState );

		//System.out.println( ", " + toString( abEndState ) + " ) = " + dTr );
	...
	*/
	...
	public Iterator<Entry<Integer,Double>> getNonZeroTransitions( int iStartState, int iAction ) {
		...
		if( mTransitions == null ){
			...
			if( Math.abs( dSumTr - 1.0 ) > 0.000001 )
				System.out.println( "getTransitionNonZeroEntries: BUGBUG - sum tr( " + iStartState + ", " + iAction + ", * ) = " + dSumTr );
		}
	...
	public Iterator<Entry<Integer,Double>> getBackwardTransitionNonZeroEntries( int iAction, int iEndState ) {
		...
		if( mTransitions == null ){
			...
			//			if( Math.abs( dSumTr - 1.0 ) > 0.000001 ) - does not sum to 1
	//			System.out.println( "getBackwardTransitionNonZeroEntries: BUGBUG - sum tr( *, " + iAction + ", " + iEndState + " ) = " + dSumTr );
		}
		return mTransitions.entrySet().iterator();
	}
	...
	@Override
	public double O(int action, int[][] aiState, int observation) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public double probStartState(int[][] aiState, int startOption) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public double tr(int[][] aiStartState, int action, int[][] aiEndState) {
		// TODO Auto-generated method stub
		return 0;
	}
