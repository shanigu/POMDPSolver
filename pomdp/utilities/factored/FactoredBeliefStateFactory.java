...
import pomdp.environments.RestrictedPOMDP;
...
public class FactoredBeliefStateFactory extends BeliefStateFactory {
	...
	public BeliefState getInitialBeliefState(){
		if( m_bsInitialState == null ){
			...
			if( m_pPOMDP instanceof RestrictedPOMDP ){
				bsInitialState.m_addProbabilities.product( 1 / dSum );
				dSum = 1.0;
			}
	...
	public boolean cacheBeliefStates( boolean bCahce ){
		boolean bPrevious = m_bCacheBelifStates;
		m_bCacheBelifStates = bCahce;
		return bPrevious;
	}
}
