...
import pomdp.utilities.skyline.EquationMatrixCreator;
...
public class LinkedList<V> implements List<V> {
	...
	public synchronized Object[] toArray() {
		Object[] aData = new Object[m_cElements];
		int iElement = 0;
		Link<V> lCurrent = m_lHead;
		for( iElement = 0 ; iElement < m_cElements && lCurrent != null ; iElement++ ){
			aData[iElement] = lCurrent.getData();
			lCurrent = lCurrent.getNext();
		}
		return aData;
	}
