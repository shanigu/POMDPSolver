...
public abstract class Task implements Serializable {
	...
	private long m_lStartWaitTime;
	private long m_lStartExecutionTime;
	private long m_lEndExecutionTime;
	
	public void setEndExecutionTime(long currentTimeMillis) {
		m_lEndExecutionTime = currentTimeMillis;
	...
	public long getStartExecutionTime() {
		return m_lStartExecutionTime;
	}

	public long getStartWaitTime() {
		return m_lStartWaitTime;
	}

	public long getEndExecutionTime() {
		return m_lEndExecutionTime;
	}

	public void setStartExecutionTime(long currentTimeMillis) {
		m_lStartExecutionTime = currentTimeMillis;
	}

	public void setStartWaitTime(long currentTimeMillis) {
		m_lStartWaitTime = currentTimeMillis;
	}
}
